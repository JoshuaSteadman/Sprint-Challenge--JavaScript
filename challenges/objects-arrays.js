...
*/
const animalNames = [];
zooAnimals.forEach((el) => animalNames.push(`Name: ${el.animal_name}, Scientific Name: ${el.scientific_name}`));
...
*/
const lowerPopulation = zooAnimals.filter(el => el.population < 5)
